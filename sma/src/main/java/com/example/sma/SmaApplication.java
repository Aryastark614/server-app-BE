...
public class SmaApplication {
	...
	// Define a CommandLineRunner bean that initializes the server repository with sample data.
	@Bean
	CommandLineRunner run(ServerRepo serverRepo) {
		return args -> {
			// Insert sample server data into the repository.
	...
	// Define a CorsFilter bean to configure Cross-Origin Resource Sharing (CORS).
	@Bean
	public CorsFilter corsFilter() {
		UrlBasedCorsConfigurationSource urlBasedCorsConfigurationSource = new UrlBasedCorsConfigurationSource();
		CorsConfiguration corsConfiguration = new CorsConfiguration();

		// Set CORS configurations, including allowed origins, headers, methods, and more.
